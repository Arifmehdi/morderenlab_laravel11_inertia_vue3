<template>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="#" method="POST" id="create_patient">
            <!-- @csrf -->
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control" name="gender" placeholder="{{__('Gender')}}" id="create_gender" required>
                                        ...
                                        <option value="" disabled selected>Select create_gender</option>
                                        <option value="male" >Malecreate_gender</option>
                                        <option value="female">Femalecreate_gender</option>
                                    </select>
                                </div>
                            </div>
                        </div>
